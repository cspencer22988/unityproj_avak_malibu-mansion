			...
			Program "vp" {
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  tmpvar_7.xy = worldSpaceVertex_3.xz;
					  highp vec2 tmpvar_8;
					  tmpvar_8 = mix (_glesMultiTexCoord0, tmpvar_7, vec4(_WorldUVs)).xy;
					  tileableUv_2 = tmpvar_8;
					  tmpvar_4.xyz = (worldSpaceVertex_3 - _WorldSpaceCameraPos);
					  tmpvar_4.w = 1.0;
					  highp vec4 tmpvar_9;
					  tmpvar_9.w = 1.0;
					  ...
					  xlv_TEXCOORD1 = ((tileableUv_2.xyxy + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD1 = ((tileableUv_2.xyxy + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					  xlv_TEXCOORD2 = ((_glesMultiTexCoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
					  xlv_TEXCOORD3 = ((tmpvar_9.z * unity_FogParams.z) + unity_FogParams.w);
					  xlv_COLOR0 = tmpvar_5;
					}
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD1 = ((tileableUv_2.xyxy + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					  xlv_TEXCOORD2 = ((_glesMultiTexCoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
					  xlv_TEXCOORD3 = exp2(-((unity_FogParams.y * tmpvar_9.z)));
					  xlv_COLOR0 = tmpvar_5;
					}
